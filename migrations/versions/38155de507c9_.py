...
Revision ID: 38155de507c9
Revises: 
Create Date: 2025-01-22 09:29:31.839314
...
def upgrade():
    ...
    sa.Column('analysed_img', sa.LargeBinary(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('location', sa.String(length=100), nullable=True),
    sa.Column('pollution_percent', sa.Float(), nullable=True),
